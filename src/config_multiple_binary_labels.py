...
_THRESHOLD_MAP = {
    '1W': ([-8, -6, -4, -2], [2, 4, 6, 8]),
    '2W': ([-10, -7.5, -5, -2.5], [2.5, 5, 7.5, 10]),
    '1M': ([-16, -12, -8, -4], [4, 8, 12, 16]),
    '2M': ([-20, -15, -10, -5], [5, 10, 15, 20]),
    '3M': ([-24, -18, -12, -6], [6, 12, 18, 24]),
    '6M': ([-36, -27, -18, -9], [9, 18, 27, 36]),
    '8M': ([-44, -33, -22, -11], [11, 22, 33, 44]),
    '1Y': ([-60, -45, -30, -15], [15, 30, 45, 60])
}
