...
class LinkPredictor(torch.nn.Module):
    ...
    """
    # 1. Add out_channels argument here
    def __init__(self, in_channels, out_channels=1):
        ...
        self.net = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(0.2),
            # 2. CRITICAL CHANGE: Use out_channels, NOT 1
...
class TGN(torch.nn.Module):
    # CHANGE 3: Add out_channels=1 argument to TGN init
    def __init__(self, num_nodes, raw_msg_dim, memory_dim, time_dim, embedding_dim, num_parties, num_states, out_channels=1):
        super().__init__()
        ...
        # 4. Link Predictor
        # CHANGE 4: Pass out_channels to the predictor
        self.predictor = LinkPredictor(
            embedding_dim + static_dim + self.price_emb_dim, 
            out_channels=out_channels # <--- Ensure this is passed!
        )
